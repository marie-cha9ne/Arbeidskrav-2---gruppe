        ...
        <section key={index}>
          ...
          {section.subSections?.map((sub, i) => (
            <div key={i}>
              ...
              {sub.body?.map((p, x) => (
                <p key={x} className={styles.content}>
                  {p}
                </p>
              ))}
              ...
              {sub.code && (
                <Example code={sub.code} className={styles.codeLine} />
              )}
              ...
              {sub.button && (
                <div className={styles.btnBox}>
                  <Link href={sub.button.href}>
                    <button className={styles.btn}>{sub.button.text}</button>
                  </Link>
                </div>
              )}
            </div>
