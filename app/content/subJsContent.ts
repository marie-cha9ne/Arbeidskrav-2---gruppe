...
export const subjectJsContent: ArticleSection[] = [
  ...
  //Output: Jane Doe
   `,
    moreText:
      "For å se den uthentede informasjonen høyreklikker du på siden - klikk på inspiser/inspect og gå til console. der vil du se at navnet gitt i objektet vises. Objekter er veldig nyttige når vi skal representere ting som finnes i virkeligheten - f.eks en bruker, en vare i en nettbutikk eller en artikkel.",
  },
  {
    title: "Arrays",
    body: [
  ...
  //Output: ["Hund", "Høne", "Hest"]
      ...
      {
        title: "Concat()",
        body: ["Med concat() kan vi slå sammen to arrays."],
        code: `
      const list1 = ["a", "b"];
      const list2 = ["c", "d"];
